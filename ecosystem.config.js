...
module.exports = {
    apps: [
        // {
        //     name: 'cmb-dev', // pm2 start App name
        ...
        //     increment_var: 'PORT', // pm2 scale toothfairy-common-api-dev 4
        ...
        // },
        {
            name: 'cmb-prod', // pm2 start App name
            script: 'dist/server.js',
            exec_mode: 'cluster', // 'cluster' or 'fork'
            instance_var: 'INSTANCE_ID', // instance variable
            increment_var: 'PORT', // pm2 scale toothfairy-common-api-prod 4
            instances: 8, //'max' pm2 instance count
            autorestart: true, // auto restart if process crash
            watch: false, // files change automatic restart
            ignore_watch: ['node_modules', 'logs'], // ignore files change
            max_memory_restart: '1G', // restart if process use more than 1G memory
