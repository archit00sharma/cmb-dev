...
export const caseSchema: Schema = new Schema(
    {
        ...
        premisesResidence: {
            type: String,
            trim: true,
            enum: ["","OWNED","COMPANY_PROVIDED","RENTED", "LEASE", "BUSINESS_CENTRE", "LOAN", "SELF_OWNED", "SHARED", "OTHER", "COMPANY_OWNED", "PARENTAL"]
        },
...
const archieveCaseModel = model<caseManagement>("archieveCaseModel", caseSchema);
export default archieveCaseModel;